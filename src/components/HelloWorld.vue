<template>
  <div>
    ...
    <v-bottom-sheet v-model="showSignUpModal">
      <template v-slot:activator="{ props }">
        <v-btn v-bind="props" text>Privacy Policy</v-btn>
      </template>
      <v-card>
        <SignUpNow />
      </v-card>
...
import SignUpNow from './SignUpNow.vue'

export default {
  components: { SignUpNow, AppHeader },
  data: () => ({
    visible: false,
